...
<objective>
Run a full code review of `watcher/github` and generate a fix prompt for each Critical or Important finding.
</objective>
...
Service directory: `watcher/github/`
</context>
...
Run `/coding:code-review full watcher/github` to get a comprehensive review with all specialist agents.
